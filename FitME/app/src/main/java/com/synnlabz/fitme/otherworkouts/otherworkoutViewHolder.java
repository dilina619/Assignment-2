...
public class otherworkoutViewHolder extends RecyclerView.ViewHolder{
    ...
    public TextView mOtherWorkoutName , mOtherWorkoutsSets , mOtherWorkoutReps , mOtherWorkoutRest;     //defining variables

    public otherworkoutViewHolder(View itemView) {
        super(itemView);

        mOtherWorkoutName = (TextView) itemView.findViewById(R.id.workoutName);     //initializing components
