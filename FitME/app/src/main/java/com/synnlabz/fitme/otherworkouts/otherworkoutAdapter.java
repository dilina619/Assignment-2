...
public class otherworkoutAdapter extends RecyclerView.Adapter<otherworkoutViewHolder> {
    private List<otherworkoutObject> otherworkoutList;      //defining variables
    private Context context;

    public otherworkoutAdapter(List<otherworkoutObject> otherworkoutList, Context context){     //constructor
        this.otherworkoutList = otherworkoutList;
        this.context = context;
    }

    @Override
    public otherworkoutViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {      //initializing layoutview
    ...
    public void onBindViewHolder(otherworkoutViewHolder holder, int position) {
        holder.mOtherWorkoutName.setText(otherworkoutList.get(position).getName());     //set values
